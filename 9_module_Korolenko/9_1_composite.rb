...
folder1 = FSFolder.new('folder_Viktor')
folder1.addFile "Irina"
folder2 = FSFolder.new('folder_Alla')
folder2.addFile(FSFile.new('Viktor'))
folder2.addFile(FSFile.new('Katya'))

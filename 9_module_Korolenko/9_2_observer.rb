...
module Vybory
  ...
  def delete_observer(*observers)
    ...
    observers.each{|e| @observers.delete(e)}
  end
...
p1 = Person.new('Viktor II')
p1.add_observer(Person.new('Alla'), Person.new('Viktor I'))
p1.count_voice('Katya')